          ...
          <section className="py-16 md:py-24 -mx-4 px-4 bg-white">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-12">
                פרויקטי <span className="text-secondary">בוטים</span> שביצענו
              </h2>
                ...
                {projectsData
                  ...
                  .map((project, index) => (
                    <Link
                      ...
                      style={{ animationDelay: `${index * 0.1}s` }}
                    >
                      <div className="bg-gray-50 rounded-2xl overflow-hidden border border-gray-200 hover:border-secondary/50 transition-all duration-300 hover:scale-[1.02] hover:-translate-y-2 hover:shadow-xl">
                        ...
                        <div className="p-6">
                          <h3 className="text-xl font-bold text-gray-900 group-hover:text-secondary transition-colors duration-300 mb-2">
                            {project.title}
                          </h3>
