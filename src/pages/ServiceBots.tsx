    ...
    <div className="min-h-screen">
      ...
      <main className="pt-32 pb-24">
        <div className="container mx-auto px-4">
          ...
          {projectsData.filter(p => p.serviceTypes.includes("bots")).length > 0 && (
                  ...
                  {projectsData
                    ...
                    .map((project, index) => (
                      <Link
                        ...
                        style={{ animationDelay: `${index * 0.1}s` }}
                      >
                        <div className="bg-white rounded-xl overflow-hidden border border-gray-200 hover:border-secondary/50 transition-all duration-300 hover:shadow-lg">
                          ...
                          <div className="p-3 md:p-4">
                            <h3 className="text-sm md:text-base font-semibold text-gray-900 group-hover:text-secondary transition-colors duration-300 line-clamp-1">
                              {project.title}
                            </h3>
                          </div>
                        </div>
