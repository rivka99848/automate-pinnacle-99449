        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 animate-fade-in-up">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              איך <span className="text-gradient">אוטומציה חכמה</span> משנה את כללי המשחק
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-brand-blue/10 backdrop-blur-sm p-8 rounded-3xl hover-lift border border-brand-blue/20 animate-fade-in-scale delay-100">
              ...
              <h3 className="text-2xl font-semibold mb-4">חסכון בזמן</h3>
            ...
            <div className="bg-secondary/10 backdrop-blur-sm p-8 rounded-3xl hover-lift border border-secondary/20 animate-fade-in-scale delay-300">
              ...
              <h3 className="text-2xl font-semibold mb-4">דיוק ומקצועיות</h3>
              <p className="text-muted-foreground">
            ...
            <div className="bg-brand-cyan/10 backdrop-blur-sm p-8 rounded-3xl hover-lift border border-brand-cyan/20 animate-fade-in-scale delay-500">
              ...
              <h3 className="text-2xl font-semibold mb-4">צמיחה מתמשכת</h3>
              <p className="text-muted-foreground">
      ...
      <section id="about" className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto text-center space-y-8 animate-fade-in-up">
            {/* כותרת קטנה */}
            <h3 className="text-2xl md:text-3xl font-light tracking-wide text-gray-700">נעים להכיר</h3>
            
            {/* כותרת ראשית גדולה */}
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-brand-dark">
              רבקה בעלת עסק <span className="text-brand-blue font-fredoka">Smartbiz</span>
            </h1>
            ...
            <div className="space-y-0 text-lg md:text-xl leading-tight max-w-4xl mx-auto text-gray-800">
              ...
              <p className="text-brand-blue font-semibold text-xl md:text-2xl leading-tight">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-gradient-to-br from-brand-blue/10 to-brand-cyan/5 p-8 rounded-3xl hover-lift border border-brand-blue/30 backdrop-blur-sm animate-fade-in-scale delay-100">
                ...
                <h2 className="text-3xl font-semibold mb-4 text-brand-dark">המשימה שלנו</h2>
              ...
              <div className="bg-gradient-to-br from-secondary/10 to-brand-purple/5 p-8 rounded-3xl hover-lift border border-secondary/30 backdrop-blur-sm animate-fade-in-scale delay-300">
                ...
                <h2 className="text-3xl font-semibold mb-4 text-brand-dark">החזון שלנו</h2>
                <p className="text-lg leading-relaxed text-gray-800">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 animate-fade-in-up">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-brand-dark">
              💡 <span className="text-brand-dark">מה אנחנו</span>{" "}
              <span className="text-brand-blue">עושים</span>
            </h2>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 animate-fade-in-up">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              <span className="text-gradient">מקרי הצלחה</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-card rounded-3xl overflow-hidden hover-lift shadow-elegant border border-brand-cyan/10 animate-fade-in-scale delay-200 group">
              ...
              <div className="p-6 flex flex-col h-full">
                ...
                <Button asChild variant="outline" className="w-full hover:bg-brand-cyan/10 hover:border-brand-cyan transition-all">
            ...
            <div className="bg-card rounded-3xl overflow-hidden hover-lift shadow-elegant border border-secondary/10 animate-fade-in-scale delay-400 group">
              ...
              <div className="p-6 flex flex-col h-full">
                ...
                <Button asChild variant="outline" className="w-full hover:bg-secondary/10 hover:border-secondary transition-all">
