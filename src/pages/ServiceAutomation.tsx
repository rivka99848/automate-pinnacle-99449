    ...
    <div className="min-h-screen">
      ...
      <main className="pt-32 pb-24">
        <div className="container mx-auto px-4">
          ...
          {projectsData.filter(p => p.serviceTypes.includes("automation")).length > 0 && (
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
                  {projectsData
                    ...
                    .map((project, index) => (
                      ...
                      >
                        <div className="bg-white rounded-xl overflow-hidden border border-gray-200 hover:border-brand-purple/50 transition-all duration-300 hover:shadow-lg">
                          ...
                          <div className="p-3 md:p-4">
                            <h3 className="text-sm md:text-base font-semibold text-gray-900 group-hover:text-brand-purple transition-colors duration-300 line-clamp-1">
                              {project.title}
                            </h3>
                          </div>
                        </div>
