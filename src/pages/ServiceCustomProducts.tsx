                  ...
                  {projectsData
                    ...
                    .map((project, index) => (
                      <Link
                        ...
                        style={{ animationDelay: `${index * 0.1}s` }}
                      >
                        <div className="bg-gray-50 rounded-2xl overflow-hidden border border-gray-200 hover:border-brand-teal/50 transition-all duration-300 hover:scale-[1.02] hover:-translate-y-2 hover:shadow-xl">
                          ...
                          <div className="p-6">
                            <h3 className="text-xl font-bold text-gray-900 group-hover:text-brand-teal transition-colors duration-300 mb-2">
                              {project.title}
                            </h3>
